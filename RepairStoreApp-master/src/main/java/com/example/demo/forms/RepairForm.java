...
public class RepairForm {
    ...
    public RepairForm(Long repairID, String description, LocalDateTime registrationDayOfRepair, LocalDateTime finishDayOfRepair, String repairStatus, String repairType, Double serviceCost, String plateNumber, Long id) {
        this.repairID = repairID;
        this.description = description;
        this.registrationDayOfRepair = registrationDayOfRepair;
        this.finishDayOfRepair = finishDayOfRepair;
